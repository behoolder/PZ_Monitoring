...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function printTable(string)
            {
                ...
                xmlhttp.open("get", url, true);
                xmlhttp.onreadystatechange = getPrintTableResult;
                xmlhttp.withCredentials = "true";
                xmlhttp.send();
            }
    ...
    <body onload ="getSubscriptions()">
        ...
        <div id ="myDiv">
            ...
            <button type="button" onClick="removeSubscription()">usun</button>
            <button type="button" onClick="showSubscription()">pokaz wartosc</button>
        </div>
    </body>
</html>
